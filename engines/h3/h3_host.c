...
int h3_serving_schedule_build(int evaluations, h3_sigma_schedule *schedule) {
    return h3_serving_schedule_build_shifts(
        evaluations, H3_VIDEO_SIGMA_SHIFT, H3_AUDIO_SIGMA_SHIFT, schedule);
}

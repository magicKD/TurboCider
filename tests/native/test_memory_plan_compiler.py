#!/usr/bin/env python3
"""Compile and execute the dependency-free memory plan compiler tests."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="turbocider-memory-plan-") as raw:
        binary = Path(raw) / "memory-plan-compiler-test"
        subprocess.run(
            [
                compiler,
                "-std=c++20",
                ...
                str(ROOT / "tests/native/memory_plan_compiler_test.cpp"),

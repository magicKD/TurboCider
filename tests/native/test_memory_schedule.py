#!/usr/bin/env python3
"""Compile and execute the dependency-free memory schedule tests."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="turbocider-memory-schedule-") as raw:
        binary = Path(raw) / "memory-schedule-test"
        subprocess.run(
            [
                compiler,
                "-std=c++20",
                ...
                str(ROOT / "tests/native/memory_schedule_test.cpp"),

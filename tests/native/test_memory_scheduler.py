#!/usr/bin/env python3
"""Compile and execute the dependency-free memory scheduler tests."""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="turbocider-memory-scheduler-") as raw:
        binary = Path(raw) / "memory-scheduler-test"
        subprocess.run(
            [
                compiler,
                "-std=c++20",
                ...
                str(ROOT / "tests/native/memory_scheduler_test.cpp"),

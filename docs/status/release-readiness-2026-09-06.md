...
当前工作树可以整理并提交一个**开发验收版本**，但不应把这次提交命名或描述为“全部模型生产版”。代码、测试、请求样例、配置样例和正式文档已经形成一个可审阅的纵切；LTX ANE、LTX I2V/音频、FLUX 9B 完整矩阵、FastMetal 独立 LoRA 和 H3/LTX 纯内存 LoRA 仍是明确的后续工作。

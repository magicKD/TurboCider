...
| 低内存 streaming/offload | CPU-staged sd.cpp layer prefetch/evict、mmap、VAE tiling；显式预算 | 256²、两个 base 1024² seed 和单 seed 1024² LoRA 可用；未证明“不影响性能”，当前明确存在 3.9–14.3% 回归 |

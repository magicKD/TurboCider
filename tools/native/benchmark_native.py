...
constructor=lib.tc_engine_create_model_candidate if a.candidate else lib.tc_engine_create_model
e,err=c.c_void_p(),c.c_void_p();start=time.perf_counter();status=constructor(a.model_id.encode(),a.model.encode(),c.byref(e),c.byref(err));message=consume(err)

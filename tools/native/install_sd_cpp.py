#!/usr/bin/env python3
"""Install TurboCider's pinned stable-diffusion.cpp Metal runtime.

The runtime is a build dependency, not a model.  It is stored below the ignored
``.deps`` tree, content-verified, and copied into native/package outputs by the
existing build scripts.  No user cache or sibling repository is adopted.
"""

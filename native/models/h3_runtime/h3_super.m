...
void h3_super_params_init(h3_super_params *params) {
    ...
    const char *input_dir = h3_runtime_getenv("H3_SUPER_INPUT_DIR");
    const char *output_dir = h3_runtime_getenv("H3_SUPER_OUTPUT_DIR");
    const char *home = h3_runtime_getenv("HOME");

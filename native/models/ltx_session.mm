...
#include "ltx_runtime/ltx_gemma_encoder.h"
#include "ltx_runtime/ltx_mlx_audio_vae.h"
#include "ltx_runtime/ltx_mlx_bwe.h"
#include "ltx_runtime/ltx_mlx_vocoder.h"
#include "ltx_runtime/ltx_mlx_video_vae.h"
#include "ltx_runtime/ltx_native.h"
#include "ltx_runtime/ltx_rng.h"
#include "ltx_runtime/ltx_video_convert.h"
...
static Conditioning load_conditioning_directory(
    ...
    require((result.connected && format == "ltx-mac-conditioning-v1") ||
            (!result.connected && format == "ltx-mac-raw-conditioning-v1"),
...
public:
    ...
    NSDictionary* generate(const Request& request,
                           const Event& event,
        ...
        if (exec_finalizer) {
             ...
             * validated by ltx-mac: it destroys Metal/MPSGraph/Core ML/MLX

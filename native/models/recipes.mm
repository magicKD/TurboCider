...
NSDictionary *make_plan(const Request& r) {
 ...
 if(hybrid)require(r.model=="flux2-klein-4b"&&r.allow_approximation&&!r.ane_manifest.empty(),"experimental hybrid requires FLUX, allow_approximation=true and ane_manifest; auto remains GPU");
